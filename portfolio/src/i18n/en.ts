...
const en: Translations = {
  ...
  features: {
    ...
    resources: {
      title: "Resources",
      description: "Practical PDF guides to understand and use LLMs. Free to download.",
    },
    articles: {
      title: "Articles",
      description: "Research notes and explorations published regularly.",
    },
  },
  latestAdds: {
  ...
  about: {
    ...
    tagline: "Full-Stack Developer · Freelance · Epitech",
    anchorCV: "Resume",
    ...
    expires: "Expires",
    fetching: "Loading GitHub languages…",
  },
  experience: {
    title: "Experience",
